...
qemu-cd: dump-config dump-deps disk
	qemu-system-$(ARCH)  -bios $(OVMF) -cdrom $(OUT_DIR)/$(OSNAME)-$(FW_LOADER).img -s -display none -d cpu_reset,int -display none -serial mon:stdio -m 86M -net none -no-reboot -machine q35
