...
const irql = @import("../../hal/hal.zig");

const Msr = @import("../../hal/arch/arch.zig").Msr;
pub const LocalApic = @import("../../hal/apic/lapic.zig");
pub const timer = @import("../../hal/apic/timer.zig");
